...
Vous disposez de deux fichiers, [employes.csv](pathname:///exercises/fichiers_employes.csv) et [heures.json](pathname:///exercises/fichiers_heures.json), contenant
respectivement des informations sur les employés d'une entreprise et leurs
heures travaillées.
